...
| [git-workflow](./git-workflow/) | Auto-detect git workflow (Graphite vs standard PRs) based on repo org and inject context hints. `/workflow` command to manage configured orgs. |
