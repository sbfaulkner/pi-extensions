...
| [workflow](./workflow/) | Auto-detect repository workflow (local git vs GitHub PRs vs Graphite) based on remote/org and inject context hints. `/workflow` command to manage configured orgs. |
